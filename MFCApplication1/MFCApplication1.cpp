...
BEGIN_MESSAGE_MAP(CMFCApplication1App, CWinApp)
	...
	ON_COMMAND(ID_VIEW_REFRESH, &CMFCApplication1App::OnViewRefresh)
END_MESSAGE_MAP()
...
SensorRepository& CMFCApplication1App::GetSensors() {
...
BOOL CMFCApplication1App::InitInstance()
{
	...
	LoadSensorRepository();

	return TRUE;
}

void CMFCApplication1App::LoadSensorRepository() {
	sensorRepository.ClearData();
	sensorRepository.LoadData(
		[](DWORD_PTR context) {
			CFrameWnd* pFrameWnd = (CFrameWnd*)context;
			pFrameWnd->PostMessageW(DATA_LOAD_COMPLETE, 0, (DWORD_PTR)&theApp);
		},
		(DWORD_PTR)m_pMainWnd);
}
...
void CMFCApplication1App::OnViewRefresh()
{
	LoadSensorRepository();
}
